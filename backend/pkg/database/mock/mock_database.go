...
func (m *MockDatabaseRepository) GetUser(ctx context.Context, userId uuid.UUID) (*models.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockDatabaseRepository) UpdateUserAndPermissions(ctx context.Context, user models.User) error {
	m.ctrl.T.Helper()
