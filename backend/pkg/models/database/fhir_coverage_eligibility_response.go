...
func (s *FhirCoverageEligibilityResponse) PopulateAndExtractSearchParameters(resourceRaw json.RawMessage) error {
	...
	insurerResult, err := vm.RunString(` 
							InsurerResult = window.fhirpath.evaluate(fhirResource, 'CoverageEligibilityResponse.insurer')
	...
	requestResult, err := vm.RunString(` 
							RequestResult = window.fhirpath.evaluate(fhirResource, 'CoverageEligibilityResponse.request')
	...
	requestorResult, err := vm.RunString(` 
							RequestorResult = window.fhirpath.evaluate(fhirResource, 'CoverageEligibilityResponse.requestor')
