...
func (s *FhirConsent) PopulateAndExtractSearchParameters(resourceRaw json.RawMessage) error {
	...
	// extracting Period
	periodResult, err := vm.RunString("extractSimpleSearchParameters(fhirResource, 'Consent.provision.period')")
	...
	sourceReferenceResult, err := vm.RunString("extractReferenceSearchParameters(fhirResource, 'Consent.source')")
